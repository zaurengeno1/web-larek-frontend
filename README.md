...
Конструктор: constructor(className: string, container: HTMLElement, options: { onClick: (event: MouseEvent) => void })
Свойства:
...
Конструктор: constructor(index: number, container: HTMLElement, options: { onClick: (event: MouseEvent) => void })
Свойства:
...
Конструктор: constructor(container: HTMLElement, total: number, options: { onClick: (event: MouseEvent) => void })
